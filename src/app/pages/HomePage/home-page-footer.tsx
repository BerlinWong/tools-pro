export const HomePageFooter = () => {
  return (
    <footer className="w-full bg-white lg:grid lg:grid-cols-5 dark:bg-gray-900">
      <div className="relative block h-32 lg:col-span-2 lg:h-full">
        <img
          src="https://images.unsplash.com/photo-1622484479642-f6c05da4ecaa?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDN8fEdyYWZmaXRpfGVufDB8fDB8fHwy"
          alt=""
        ...
        <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
              &copy; 2024. 302.Server. All rights reserved.
            </p>
          </div>
        </div>
      </div>
